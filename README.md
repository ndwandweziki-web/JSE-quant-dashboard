{
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "authorship_tag": "ABX9TyOb3QZrNCNHulFXSTkUsEbB",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/ndwandweziki-web/JSE-quant-dashboard/blob/main/README.md\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
      ...
      "metadata": {
        ...
        "id": "lRVWCDotznB9",
        "outputId": "a8425565-b588-44a7-f47c-4d45d6d9e326"
      },
      "outputs": [
        {
          "output_type": "stream",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "577HZ7RV4OAM",
        "outputId": "75332688-a0ca-4388-838c-31ec687f1d89"
      },
      "execution_count": 5,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "EdkB3Ldv6Su2",
        "outputId": "ab9303e5-61c1-4fef-f42f-3247a7812d97"
      },
      "execution_count": 6,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "8dWlcrDh7pse",
        "outputId": "889c024c-36c4-4151-d577-011c14151354"
      },
      "execution_count": 7,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "fFcbfM-L-8qU",
        "outputId": "c9cbc473-cf99-4abf-93a4-e30608a26882"
      },
      "execution_count": 8,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "vnSoNVLwYZb-",
        "outputId": "12a7b95c-e798-417b-b14d-4daf818aa7c3"
      },
      "execution_count": 9,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "Xw2eCBfzZAf6",
        "outputId": "19e6016a-e1e8-4965-ab86-253a4ade4cc7"
      },
      "execution_count": 10,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "3b32UzF-akB6",
        "outputId": "fcef05d5-40af-4577-c0c3-3eb312ff972e"
      },
      "execution_count": 11,
      "outputs": [
        {
    ...
    },
    {
      "cell_type": "code",
      "source": [
        "markdown_content = \"\"\"# Dynamic Regime-Switching Quantitative Trading Engine (JSE)\n",
        "\n",
        "A production-ready quantitative research and execution framework built from first principles to model structural breaks and predict future equity returns on the Johannesburg Stock Exchange (JSE).\n",
        "\n",
        "By rejecting static global linear assumptions, this framework dynamically shifts its statistical predictive models based on macroeconomic volatility states.\n",
        "\n",
        "---\n",
        "\n",
        "## 🛠️ Core Mathematical & Engineering Architecture\n",
        "\n",
        "1. **Algorithmic Data Pipeline & Leakage Rectification**\n",
        "   * Extracted daily closing prices for **Standard Bank (SBK.JO)**, **FirstRand (FSR.JO)**, and the **JSE Top 40 Index (^J200.JO)** over a 5-year horizon.\n",
        "   * Transformed raw assets into stationary time series via daily log returns: $R_t = \\\\ln(P_t / P_{t-1})$.\n",
        "   * Engineered a 10-day rolling standard deviation of index returns to track time-varying market volatility.\n",
        "   * **Look-Ahead Bias Resolution:** Mathematically shifted the target vector backwards by 1 day (`.shift(-1)`) to ensure features strictly predict future horizons, eliminating information leakage.\n",
        "\n",
        "2. **Unsupervised Market State Clustering (K-Means from Scratch)**\n",
        "   * Implemented the standard convergence loop using pure NumPy matrix operations to optimize the Within-Cluster Sum of Squares (Inertia).\n",
        "   * Automatically segmented the market timeline into exactly 3 structural regimes based on JSE Index return distributions and rolling volatility.\n",
        "\n",
        "3. **Supervised Decision Space Mapping (LDA from Scratch)**\n",
        "   * Built Linear Discriminant Analysis by maximizing the ratio of the **Between-Class Scatter Matrix ($S_B$)** to the **Within-Class Scatter Matrix ($S_W$)**.\n",
        "   * Derived an optimized projection matrix $W$ using sorted eigenvalues to build a real-time model routing layer for unseen daily data.\n",
        "\n",
        "4. **Localized OLS Regression Optimizations**\n",
        "   * Executed independent localized Ordinary Least Squares (OLS) regressions via the classic mathematical Normal Equation:\n",
        "     $$\\\\beta_k = (X_k^T X_k)^{-1} X_k^T y_k$$\n",
        "   * Exposed hidden alpha by revealing that the competitive beta coefficient of FirstRand (FSR) shifts dynamically from positive during macro panic events to deeply negative during high-volatility growth environments.\n",
        "\n",
        "---\n",
        "\n",
        "## 💻 Tech Stack & Tooling\n",
        "* **Core Engine:** NumPy, Pandas\n",
        "* **Data Ingestion:** Yahoo Finance API (`yfinance`)\n",
        "* **Environment:** Google Colab / Jupyter Notebooks\n",
        "\"\"\"\n",
        "\n",
        "# Write the text locally into the Colab environment instance\n",
        "with open(\"README.md\", \"w\") as f:\n",
        "    f.write(markdown_content)\n",
        "\n",
        "print(\"Technical README.md file generated successfully in local environment workspace!\")\n",
        "print(\"To commit this file, simply use the 'Save a copy in GitHub' menu option once more.\")"
      ],
      "metadata": {
        "colab": {
          "base_uri": "https://localhost:8080/"
        ...
        "id": "lwOgoEmBb4SI",
        "outputId": "6adceaaf-8421-4486-d787-ceb06d1ac619"
      },
      "execution_count": 12,
      "outputs": [
        {
          ...
          "name": "stdout",
          "text": [
            "Technical README.md file generated successfully in local environment workspace!\n",
            "To commit this file, simply use the 'Save a copy in GitHub' menu option once more.\n"
          ]
        }
      ]
    }
